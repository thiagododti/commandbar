...
SELECT * FROM COMANDAS WHERE COM_MESA = 2 AND COM_STATUS = "Aberta";

INSERT INTO COMANDAS (COM_MESA,COM_STATUS) VALUE (3,'FECHADA');
...
SELECT * FROM ALMOXARIFADOS GROUP BY PROD_ID;
