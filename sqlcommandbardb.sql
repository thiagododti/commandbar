...
delete FROM funcionarios where FUNC_ID = 2;

INSERT INTO FUNCIONARIOS (FUNC_NAME, FUNC_SNAME, FUNC_CPF, FUNC_PASS,FUNC_CARG, FUNC_EMAIL, FUNC_SAL, FUNC_ADMDATE)  
VALUES ('administrador','adm',11111111111,'$2y$10$1LaWiNz3mhJylVqLqICAuugfWBcF05vZPrYAULD07sUTE8xR0OuBm','gerente','adm@adm.com.br',1000.00,'2000-01-01');
